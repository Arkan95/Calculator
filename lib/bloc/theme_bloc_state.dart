...
//Tema Chiaro. Restituisce un oggetto di tipo ThemeData dove vengono settati tutte le proprietà dei futuri sotto-widget.
  ThemeData lightMode() {
    return ThemeData(
      ...
      textTheme:
          lightTextTheme, // Le impostazioni testo definite precedentemente
    );
  }
...
//Tema Scuro. Restituisce un oggetto di tipo ThemeData dove vengono settati tutte le proprietà dei futuri sotto-widget.
  ThemeData darkMode() {
    return ThemeData(
      ...
      textTheme:
          darkTextTheme, // Le impostazioni testo definite precedentemente
    );
  }
}

final class ThemeBlocDark extends ThemeBlocState {}

final class ThemeBlocLight extends ThemeBlocState {}
